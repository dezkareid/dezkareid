...
```bash
INIT=$(node ./.gemini/get-shit-done/bin/gsd-tools.js init execute-phase "${PHASE}")
```
...
<final_commit>
```bash
node ./.gemini/get-shit-done/bin/gsd-tools.js commit "docs({phase}-{plan}): complete [plan-name] plan" --files .planning/phases/XX-name/{phase}-{plan}-SUMMARY.md .planning/STATE.md
```
